...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "{file} kiterjesztése nem megfelelő. Engedélyezett kiterjesztés(ek): {extensions}.",
            sizeError: "A {file} túl nagy méretű. A maximum fájlméret: {sizeLimit}.",
            minSizeError: "A {file} túl kis méretű. A minimum fájlméret: {minSizeLimit}.",
            emptyError: "A {file} üres, kérlek válaszd ki újra a fájlokat ennek a fájlnak a kihagyásával.",
            noFilesError: "Nincs feltöltendő fájl.",
            onLeave: "A fájlok feltöltése folyamatban, ha kilépsz megszakad a feltöltés."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            retryButton: 'Újra',
            deleteButton: 'Törlés',
            failUpload: 'Feltöltés sikertelen',
            dragZone: 'Húzd ide a fájlokat.',
            dropProcessing: 'Fájlok feldolgozása...',
            formatProgress: "{percent}% a {total_size}-ból",
            waitingForResponse: "Kérlek várj..."
        },
        ...
        messages: {
            tooManyFilesError: "Csak egy fájlt húzhatsz ide."
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "Újra próbálkozás {retryNum}/{maxAuto}...",
            showButton: false
        },
        deleteFile: {
            forceConfirm: false,
            confirmMessage: "Biztos vagy benne, hogy törölni akarod a fájlt: {filename}?",
            deletingStatusText: "Törlés...",
            deletingFailedText: "Törlés sikertelen"
